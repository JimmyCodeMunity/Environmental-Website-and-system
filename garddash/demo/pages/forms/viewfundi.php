            ...
            <div class="menu-button-container menu-profile d-none d-md-block">
              <button class="mdc-button mdc-menu-button">
                <span class="d-flex align-items-center">
                  <span class="figure">
                    <img src="images/<?=$row['image']; ?>" style="border-radius: 50%;width: 25px;height: 25px;border: 1px solid blue;" alt="user" class="user">
                  </span>
              ...
              <div class="mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-6-desktop stretch-card">
                <div class="mdc-card">
                  ...
                  <div class="template-demo">
                    <img src="images/<?=$row['image']; ?>" alt="dp" class="img-a img-fluid" style="border-radius: 50%;border: 2px solid blue;" width='100px' height='100px'>
                    <div class="card-body">
                      <br>
                      <br>
                      <br>
