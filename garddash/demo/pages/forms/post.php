...
if(isset($_POST['saveimage'])){
  ...
  $update_data = "UPDATE posts SET image1 ='$profile_pic' WHERE sender='$sender' ";
...
if(isset($_POST['updatepost'])){
  ...
  $allowed_ext = array("png","jpg","webp");
  ...
  $update_post = "UPDATE posts SET image1='$profile_pic' WHERE sender = '$sender' ";
...
if(isset($_POST['insert'])){
  ...
  $update_post = "INSERT INTO posts (sender,image1)VALUES('$sender','$profile_pic')";
  mysqli_query($conn,$update_post);
  echo '<meta http-equiv="refresh" content="0">';
...
//count bookings
$book = "SELECT * FROM posts WHERE sender = '{$_SESSION['gard_email']}'";
            ...
            <div class="menu-button-container menu-profile d-none d-md-block">
              <button class="mdc-button mdc-menu-button">
                <span class="d-flex align-items-center">
                  <span class="figure">
                    <img src="images/<?=$row['image1']; ?>" style="border-radius: 50%;width: 25px;height: 25px;" alt="user" class="user">
                  </span>
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-card">
                  ...
                  <img src="images/<?=$row['image1']; ?>" alt="dp" class="img-a img-fluid" width='300px' height='200px'>
                  <div class="template-demo">
                    <div class="mdc-layout-grid__inner">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--with-trailing-icon">
                          ...
                          <input class="" type="file" name="profile_pic" required>
                    ...
                    <?php
                    if(mysqli_num_rows($countbk) > 0){
                      echo "<button type='submit' name='saveimage' class='btn btn-primary btn-lg'>Update</button>";
                    }
                    else{
                      echo "<button type='submit' name='insert' class='btn btn-success btn-lg'>Upload</button>";
