...
if(isset($_GET['type']) && $_GET['type']!=''){
  ...
  if($type=='status'){
    ...
    $update_status_sql="update gardeners set status='$status' where id='$id'";
...
$sql="SELECT * FROM bookings WHERE gardener ='{$_SESSION['gard_name']}'";
$res=mysqli_query($conn,$sql);


//booking notification
$book = "SELECT count(*) FROM bookings WHERE gardener = '{$_SESSION['gard_name']}'";
...
<head>
  ...
  <title>Reports</title>
  <script>
//add this JavaScript code to your page or a separate file
      ...
      <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="../forms/viewbookings.php">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">track_changes</i>
                Bookings
              </a>
            </div>
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="../forms/post.php">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">track_changes</i>
                Add Post
              </a>
            </div>
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Successful jobs</h6>
                  <button id="printBtn" class="btn btn-primary btn-sm">Print Receipt</button>
          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop d-flex justify-content-end">
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center tx-14">Free <a href="https://www.bootstrapdash.com/material-design-dashboard/" target="_blank"> Green Company </a> </span>
              </div>
            </div>
          </div>
        </footer>
