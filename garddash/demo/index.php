...
@include('config.php');
session_start();
$collect = "SELECT * FROM gardeners";
$result = mysqli_query($conn,$collect);
  $row = mysqli_fetch_array($result);


//count fundis available
$regist = "SELECT count(*) FROM gardeners";
$signups = mysqli_query($conn,$regist);


//query completed bookings
$query = "SELECT count(*) FROM bookings WHERE gardener = '{$_SESSION['gard_name']}' && status = 1";
$query_run = mysqli_query($conn,$query);


//check price total
$query1 = "SELECT * FROM bookings WHERE gardener = '{$_SESSION['gard_name']}' && status = 1";
$query_run1 = mysqli_query($conn,$query1);
//count bookings
$book = "SELECT count(*) FROM bookings WHERE gardener = '{$_SESSION['gard_name']}' && status = 0";
$countbk = mysqli_query($conn,$book);

//count userdata
$cl = "SELECT count(*) FROM userdata WHERE status = 1";
  ...
  <div class="body-wrapper">
      ...
      <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="../demo/pages/forms/post.php">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">track_changes</i>
                Add Post
              </a>
            </div>
    ...
    <div class="main-wrapper mdc-drawer-app-content">
      ...
      <header class="mdc-top-app-bar">
        ...
        $query_command = "SELECT * FROM bookings WHERE username = '{$_SESSION['gard_name']}' && status = 1";
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--danger">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom"><?php echo $bookcomplete ?></h5>
