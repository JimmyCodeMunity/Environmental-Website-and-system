...
if(isset($_POST['update'])){
  ...
  //image
  $path="garddash/demo/pages/forms/images/".basename($image_name);
  ...
  $update_data = "UPDATE gardeners SET regnumber='$idnum',image='$profile_pic',price='$price' WHERE id='$logid' ";
      ...
      <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Complete Signup for <?php echo $logid?></h5>
              </div>
              <div class="card-body">
              <?php
          if (isset($error)) {
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="idnumber" class="form-control" placeholder="123456789" value="" required>
                      </div>
                    </div>
                    ...
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>Price</label>
                        <input type="text" name="price" class="form-control" placeholder="Kshs." value="" required>
                      </div>
                    </div>
